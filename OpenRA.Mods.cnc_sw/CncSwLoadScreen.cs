...
namespace OpenRA.Mods.cnc_sw
{
    public class CncSwLoadScreen : ILoadScreen
    {
		...
		Sprite nodLogo, gdiLogo, brightBlock, dimBlock;
		Rectangle Bounds;
		Renderer r;
		...
		public void Init(Dictionary<string, string> info)
		{
			...
			var s = new Sheet("mods/cnc_sw/uibits/chrome.png");
		...
		public void Display()
		{
            ...
            //versionFont.DrawTextWithContrast(versionText, evaPos, Color.White, Color.Black, 2);
