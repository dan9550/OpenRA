...
WorldLoaded = function()
	...
	NodObjective1 = nod.AddPrimaryObjective("Investigate the nearby village for reports of \nstrange activity")
	...
	Trigger.AfterDelay(DateTime.Seconds(200), function() ReinforceWithLandingCraft(BikeReinforcments, SeaEntryA.Location, BeachReinforceA.Location, BeachReinforceA.Location) end)
	Trigger.AfterDelay(DateTime.Seconds(220), function() ReinforceWithLandingCraft(BikeReinforcments, SeaEntryB.Location, BeachReinforceB.Location, BeachReinforceB.Location) end)
